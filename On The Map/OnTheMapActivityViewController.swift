//
//  OnTheMapActivityViewController.swift
//  On The Map
//
...
public class OnTheMapActivityViewController: UIViewController {
    ...
    public class OnTheMapActivityViewResponder {
        ...
        let activityView:OnTheMapActivityViewController
        
        init(activityView:OnTheMapActivityViewController) {
